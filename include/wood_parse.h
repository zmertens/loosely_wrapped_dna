...
struct newick_grammar
    : qi::grammar<Iterator, wood::data_type(), standard::space_type> {
    ...
    newick_grammar() : newick_grammar::base_type(start) {
        ...
        tip =
            label[push_back(_r1, construct<wood_node>(_1))][_val = 1] >>
